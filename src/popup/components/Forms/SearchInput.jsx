    ...
    return (
        <div className="relative flex h-full items-center
            ...
            <input type="search" placeholder="Search for friends or players" className={`bg-globalBgColor  border-[1.2px] rounded-[15px] focus:border-primary
                                                                px-[16px] py-[11px] text-[#929298] text-base w-full ${typing ? 'border-primary' : 'border-[#272829]'}`} onChange={(e) => { e.target.value !== '' ? setTyping(true) : setTyping(false) }} />
