...
const sol = chrome.runtime.getURL('static/img/payModal/SOL.svg')
const usdc = chrome.runtime.getURL('static/img/payModal/USDC.svg')
const verce = chrome.runtime.getURL('static/img/payModal/VERCE.svg')
...
constructor() {
  ...
  onInputchange(event) {
    ...
    let settings = $('[name="input_amount"]').data('settings');
